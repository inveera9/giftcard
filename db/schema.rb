...
ActiveRecord::Schema.define(version: 20150520090117) do
  ...
  create_table "giftcard_details", force: :cascade do |t|
    t.integer  "value"
    t.string   "name"
    t.string   "message"
  ...
  add_index "giftcard_details", ["user_id"], name: "index_giftcard_details_on_user_id", using: :btree
